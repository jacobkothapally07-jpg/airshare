...
| :--- | :--- | :--- |
| **Frontend** | [Netlify](https://netlify.com) | Base: `client` • Publish: `dist` • Environment: `VITE_SIGNAL_SERVER_URL` |
| **Signaling Server** | [Render](https://render.com) | Node.js Web Service • Build: `npm install && npm run build` • Start: `npm start` |
